...
from tools.car_tools import cancel_car_rental, update_car_rental, book_car_rental, search_car_rentals
...
from tools.trip_tools import book_excursion, search_trip_recommendations, update_excursion, cancel_excursion

filght_booking_prompt = ChatPromptTemplate.from_messages(
    [
        (
            'system',
            "您是专门处理航班查询，改签和预定的助理。"
...
update_flight_runnable = filght_booking_prompt | llm.bind_tools(
